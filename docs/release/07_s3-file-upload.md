...
2. Bucket name: `reel-s3-bucket-404304993527-ap-southeast-2-an` (전 세계 유일해야 함)
3. Region: `ap-southeast-2` (서울)
  ...
  "Statement": [
    {
      ...
      "Principal": "*",
      "Action": "s3:GetObject",
      "Resource": "arn:aws:s3:::reel-s3-bucket-404304993527-ap-southeast-2-an/*"
    }
  ]
}
```
...
| `AWS_S3_BUCKET` | `reel-s3-bucket-404304993527-ap-southeast-2-an` |
